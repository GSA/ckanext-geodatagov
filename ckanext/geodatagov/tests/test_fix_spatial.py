...
class TestSpatialField(object):
    ...
    def test_numeric_spatial_transformation(self):
        ...
        pkg = {
            "title": "Spatial num",
            "name": "spatial-num",
            "extras": [{"key": "spatial", "value": old_geo}],
        }
        dataset = p.toolkit.get_action("package_create")(context, pkg)

        expected_spatial = (
            '{"type": "Polygon", "coordinates": [[[10.0, 0.0], [10.0, 5.0], [15.0, 5.0], '
            "[15.0, 0.0], [10.0, 0.0]]]}"
        )
        ...
        result = helpers.call_action("package_search", extras={"ext_bbox": "9,-1,16,4"})
    ...
    def test_string_spatial_transformation(self):
        ...
        result = helpers.call_action(
            "package_search", extras={"ext_bbox": "-125,31,-113,43"}
        )
    ...
    def test_list_spatial_transformation(self):
        ...
        expected_spatial = (
            '{"type": "Polygon", "coordinates": [[[20.0, 10.0], [20.0, 15.0], [25.0, 15.0], '
            "[25.0, 10.0], [20.0, 10.0]]]}"
        )
        spatial_extra_exists = False
        for extra in dataset["extras"]:
        ...
        result = helpers.call_action(
            "package_search", extras={"ext_bbox": "19,9,26,16"}
        )
